...
Subtitle: Every layout type showcased in one comprehensive deck
...
- Card density: airy
- Table style: regulatory_clean
- Brand logo: assets/brand/sample-logo.png
